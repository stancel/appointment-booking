        ...
        if ( empty ( $info_text_codes ) ) {
            ...
            switch ( $step ) {
                ...
                default:
                    ...
                    $cart_info = $userData->cart->getInfo( $step == Steps::PAYMENT || $step == Steps::DONE );  // >= step payment
                    if ( $step == Steps::DONE ) {
                        $cart_info = Lib\Proxy\Shared::applyPaymentSpecificPrice( $cart_info, $userData->getPaymentType() );
                    }
