...
<div class="row">
    <div class="col-xs-12 col-md-3">
        <form action="<?php echo esc_url( $action ) ?>" method="post">
            ...
            <input type="image" class="img-responsive"
                   src="<?php echo plugins_url( 'appointment-booking/backend/resources/images/buy10.png' ) ?>"
    ...
    <div class="col-xs-12 col-md-3">
        <form action="<?php echo esc_url( $action ) ?>" method="post">
            ...
            <input type="hidden" name="landing_page" value="billing">
            <input type="image" class="img-responsive"
                   src="<?php echo plugins_url( 'appointment-booking/backend/resources/images/buy25.png' ) ?>"
                   border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
            <img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif"
                 width="1" height="1">
        </form>
    ...
    <div class="col-xs-12 col-md-3">
        <form action="<?php echo esc_url( $action ) ?>" method="post">
            ...
            <input type="hidden" name="landing_page" value="billing">
            <input type="image" class="img-responsive"
                   src="<?php echo plugins_url( 'appointment-booking/backend/resources/images/buy50.png' ) ?>"
                   border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
            <img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif"
                 width="1" height="1">
        </form>
    ...
    <div class="col-xs-12 col-md-3">
        <form action="<?php echo esc_url( $action ) ?>" method="post">
            ...
            <input type="hidden" name="landing_page" value="billing">
            <input type="image" class="img-responsive"
                   src="<?php echo plugins_url( 'appointment-booking/backend/resources/images/buy100.png' ) ?>"
                   border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
            <img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif"
                 width="1" height="1">
        </form>
