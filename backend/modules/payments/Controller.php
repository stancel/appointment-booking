...
class Controller extends Lib\Base\Controller
{
    ...
    public function index()
    {
        ...
        $this->render( 'index', compact( 'types', 'providers', 'services', 'customers' ) );
    }
    ...
    public function executeGetPaymentDetails()
    {
        ...
        if ( $payment ) {
            ...
            $data['show'] = array(
                ...
                'gateway' => Lib\Proxy\Shared::existSpecificPriceSettings( $data['type'] ) === true,
